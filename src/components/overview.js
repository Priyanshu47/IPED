...
const overview = () => {
  return (
    ...
    <div className="w-[660px] flex flex-wrap py-3 justify-between ">
    <div className="w-[320px] h-[176px] col-span-2 flex flex-row rounded-2xl mb-3 items-center justify-center border border-light-pink">
      <div className="w-40 h-44">
      <img className="w-full h-full p-4" loading="lazy" src="" />
      </div>
      <div className="w-40 h-44 p-4 py-12 justify-center items-center ">
